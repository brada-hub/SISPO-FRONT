<template>
  <q-page class="p-6">
    <div class="flex justify-between items-center mb-6">
      ...
      <q-btn label="Nuevo Cargo" icon="add" style="background-color: #009999; color: white;" @click="openDialog()" rounded unelevated class="shadow-2" />
    </div>
    ...
    <q-dialog v-model="dialog">
      <q-card class="min-w-[400px] rounded-2xl overflow-hidden">
        ...
        <q-card-actions align="right" class="text-primary q-pb-md q-px-md">
          ...
          <q-btn label="Guardar Cargo" color="primary" @click="save" :loading="saving" rounded unelevated class="q-px-lg shadow-2" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </q-page>
